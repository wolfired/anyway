...
ant compile_core -DFLEX_HOME=$APACHE_FLEX_HOME -DPLAYERGLOBAL_HOME=$PLAYERGLOBAL_HOME -Dconfig.player.version=$PLAYER_VERSION_MAJOR.$PLAYER_VERSION_MINOR -Dconfig.swf.version=$SWF_VERSION
