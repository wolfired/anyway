package anyway.geometry {
	 ...
	 * ，因此其转换矩阵为列矩阵
	 * <img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=M=\begin{bmatrix}m_{11} %26 m_{21} %26 m_{31} %26 m_{41}\\ m_{12} %26 m_{22} %26 m_{32} %26 m_{42}\\ m_{13} %26 m_{23} %26 m_{33} %26
	 * m_{43}\\ m_{14} %26 m_{24} %26 m_{34} %26 m_{44}\end{bmatrix}"/>
	 ...
	 * ，因此其转换矩阵为行矩阵
	 * <img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=M=\begin{bmatrix}m_{11} %26 m_{12} %26 m_{13} %26 m_{14}\\ m_{21} %26 m_{22} %26 m_{23} %26 m_{24}\\ m_{31} %26 m_{32} %26 m_{33} %26
	 * m_{34}\\ m_{41} %26 m_{42} %26 m_{43} %26 m_{44}\end{bmatrix}"/>
	 ...
	 * <p><img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=k \times \left ( l \times \vec{a} \right ) = \left ( k \times l \right ) \times \vec{a} = \vec{a} \times \left ( k \times l \right
	 * )"/></p>
	 ...
	 * <p><img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=k \times \left ( \vec{a} \cdot \vec{b} \right ) = \left ( k \time \vec{a} \right ) \cdot \vec{b} = \vec{a} \cdot \left ( k \time
	 * \vec{b} \right )"/></p>
	...
	public final class AWVector {
		...
		/**
		 * 向量叉积（向量积）
		 * <p><img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=\vec{a} \times \vec{b} = \left | \vec{a} \right | \times \left | \vec{b} \right | \times \sin \theta \times \vec{v} =
		 * \vec{c}"/></p>
		 ...
		 * <p>右手坐标系中，右手四指并拢从<img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=\vec{a}"/>经<img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=\theta"/>弯向<img
		 * src="http://chart.apis.google.com/chart?cht=tx&#38;chl=\vec{b}"/>时拇指伸直所指方向</p>
		 * <p>左手坐标系中，左手四指并拢从<img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=\vec{a}"/>经<img src="http://chart.apis.google.com/chart?cht=tx&#38;chl=\theta"/>弯向<img
		 * src="http://chart.apis.google.com/chart?cht=tx&#38;chl=\vec{b}"/>时拇指伸直所指方向</p>
		 * @param target
		 */
